...
def load_dataset(mode):
    ...
    if mode == 'train':
        train_file = os.path.join(data_dir, 'train_koe_eng.csv') # edit
        train_data = pd.read_csv(train_file, encoding='utf-8')

        valid_file = os.path.join(data_dir, 'val_kor_eng.csv') # edit
        ...
        test_file = os.path.join(data_dir, 'test_kor_eng.csv') # edit
